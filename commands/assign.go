...
func members(category string) ([]string, int) {
	...
	case BACK:
		return []string{YABUSHITA, NAKAYAMA, KATAGIRI, TOUYAMA, KISHIMOTO}, OK
	case TECHPERM:
		return []string{SUMIYOSHI, UESHIMA, YABUSHITA, NAKAYAMA, KAMINAGA, KOSHIMIZU}, OK
	case ALL:
		return []string{SUMIYOSHI, UESHIMA, YABUSHITA, NAKAYAMA, KATAGIRI, KATO, KAMINAGA, YANBE, TAKADA, TOUYAMA, KOSHIMIZU, KISHIMOTO, SATO, MANGOKU}, OK
	default:
		return nil, NG
	}
}
