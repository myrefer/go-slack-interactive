...
func Kpt2(ev *api.MessageEvent, client *api.Client) {
	...
	//perm := []string{SUMIYOSHI, UESHIMA, NAKAYAMA, KAMINAGA, KOSHIMIZU}
	teamA := []string{KATO, NAKAYAMA, YANBE, KISHIMOTO, MANGOKU, YSATO, MASAKA}
	permA := []string{NAKAYAMA, KISHIMOTO, MANGOKU, YSATO, MASAKA}
	teamB := []string{SUMIYOSHI, KAMINAGA, KATAGIRI, KOSHIMIZU, TAKADA, TOUYAMA, KOBAYASHI, UESHIMA}
	permB := []string{SUMIYOSHI, KAMINAGA, KOSHIMIZU, UESHIMA}
